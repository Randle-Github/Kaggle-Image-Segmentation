...
import math
import logging
logging.basicConfig(level=logging.INFO,filename='/home/wangjingqi/hthb/train.log',format='%(asctime)s %(message)s')
...
def norm_loss(outputs, targets):
    return 0.25*(lovasz_hinge(outputs, targets) + 3*lovasz_hinge(-outputs, 1.0 - targets))
