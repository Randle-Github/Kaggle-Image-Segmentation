...
class scoat(nn.Module):
    ...
    def __init__(self,
        ...
        self.logit = TransformerLearner(dim=decoder_dim,
                                 num_heads=8,
...
def scoat_layers(m):
    ...
    return [
        ...
        # aspp bottleneck
       list(m.logit.parameters())+ list(m.head.parameters())+list(m.aux.parameters())
    ]
